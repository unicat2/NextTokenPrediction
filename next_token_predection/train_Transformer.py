...
def get_args_parser():
    ...
    # Training parameters
    parser.add_argument('--output_dir', default='./output_attention',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='./output_attention',
...
def main(args):
    ...
    model = TransformerModel(vocab_size=args.vocab_size, max_len=args.max_len, embedding_dim=args.embedding_dim,
                             num_heads=args.head).to(args.device)
    ...
    def train_one_epoch(epoch):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            tokens = tokenizer(batch, truncation=True, padding=True, max_length=args.max_len, return_tensors='pt').to(
                args.device)
